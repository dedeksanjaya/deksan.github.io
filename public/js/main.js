...
(() => {
    ...
    // attach an event headler to document
    document.addEventListener("click", (event) => {
        if (event.target.classList.contains("link-item")) {
            /*-- make sure event.target.hash has a value befero overrindding default behavior --*/
...
(() => {
    ...
    function popupSlideshow() {
        ...
        //activate loader until the popupImg leaded
